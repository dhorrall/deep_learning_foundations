...
class NeuralNetwork(object):
    ...
    def train(self, inputs_list, targets_list):
        ...
        #the following line is not corrrect becase we are not using the deriviative of sigmoid.
        #We are using f(x) = x so f'(x) = x  We do this because this is not classifcation problem 
        #where we would need probablity in the range 0-1 but a regression
        ...
        #because we are using f(x) =x the slope is 1
        output_grad = 1
...
# 
# #### Your answer below
# The model seems to predict fairly well except it seems to diverge around the end of December perhaps due to seasonality.
