...
last_loss = None
# Initialize weights
# 6 x 3 arrary because there are 6 features in dataset and 3 hidden nodes in a signle hidden layer
weights_input_hidden = np.random.normal(scale=1 / n_features ** .5,
                                        size=(n_features, n_hidden))

# 1 by 3 matrix because there are 3 hidden nodes and 1 output target
